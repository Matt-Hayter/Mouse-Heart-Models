#ifndef ATRIAL_CELL_CONFIGURATION_HPP
#define ATRIAL_CELL_CONFIGURATION_HPP

/*
Alter atrial_configuration to fit the required experiment.

All other atrial cell parameters can be configured from within atrial_cell's member data, or within related ODE functions
*/
...
{
    const std::string initial_filename = "atrial_final_states.dat"; //File containing initial states to be parsed. Must be within "input_folder/atrial_inputs"
    ...
    //Other configs
    const bool K_junction_current = true; //Stimulus current is potassium
