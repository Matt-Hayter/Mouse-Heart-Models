...
//ODEs for camkiis
void atrial_cell::camkii_ODEs(const double &time)
{
    ...
    double CaMKIItotJunc = (atrial_config.ACUTE == 1 && time > atrial_config.ACUTE_TIME) ? _n_OE_ * _CaMKIItotJunc_ : _CaMKIItotJunc_;
    double CaMKIItotSL = (atrial_config.ACUTE == 1 && time > atrial_config.ACUTE_TIME) ? _n_OE_ * _CaMKIItotSL_ : _CaMKIItotSL_;
    double CaMKIItotCyt = (atrial_config.ACUTE == 1 && time > atrial_config.ACUTE_TIME) ? _n_OE_ * _CaMKIItotCyt_ : _CaMKIItotCyt_;
